...
public class FragmentBeTam extends FragmentSanPham implements ViewHienThiDanhSachSanPham, ILoadMore{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                refreshItems("layDanhSachSanPhamTheoLoaiSP", 5);
            }
        });
    ...
    public void setDangList(boolean dangList){
        ...
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamTheoLoaiSP", 5,
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterLogicSanPham.layDanhSachSanPhamLoadMore(
                "layDanhSachSanPhamTheoLoaiSP", 5, tongItem, idKhachHang, giaTri, sapXep);
