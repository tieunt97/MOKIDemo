...
public class FragmentSanPhamBan extends Fragment implements ViewHienThiDSSanPhamKhachHang, ILoadMore{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterSanPhamKhachHangLogic.layDSSanPham("layDSSanPhamMuaBan", TrangChuActivity.khachHang.getIdKhachHang(), 0, 1, 0);
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterSanPhamKhachHangLogic.layDSSanPhamLoadMore("layDSSanPhamMuaBan", TrangChuActivity.khachHang.getIdKhachHang(), tongItem, 1, 0);
