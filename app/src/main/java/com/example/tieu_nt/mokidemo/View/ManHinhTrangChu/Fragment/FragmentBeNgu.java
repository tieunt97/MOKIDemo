...
public class FragmentBeNgu extends Fragment implements ViewHienThiDanhSachSanPham{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamTheoLoaiSP", 4, 0, idKhachHang);
        return view;
    }
