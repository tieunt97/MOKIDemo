...
public class FragmentDangXuLy extends Fragment implements ViewHienThiDSSanPhamKhachHang, ILoadMore {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterSanPhamKhachHangLogic.layDSSanPham("layDSSanPhamMuaBan", DangNhap.getInstance().getKhachHang().getIdKhachHang(), 0, 1, 1);
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterSanPhamKhachHangLogic.layDSSanPhamLoadMore("layDSSanPhamMuaBan", DangNhap.getInstance().getKhachHang().getIdKhachHang(), tongItem, 1, 1);
