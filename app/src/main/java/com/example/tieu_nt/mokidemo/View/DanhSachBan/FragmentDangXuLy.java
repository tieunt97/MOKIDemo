...
public class FragmentDangXuLy extends Fragment implements ViewHienThiDSDonHang, ILoadMore {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterSanPhamKhachHangLogic.layDSDonHang("layDSDonHangBan", idKhachHang, 0, DonHang.TRANGTHAI_DANGXULY);
    ...
    public void loadMore(int tongItem) {
        List<DonHang> donHangLoadMore = presenterSanPhamKhachHangLogic.layDSDonHangLoadMore("layDSDonHangBan", idKhachHang, tongItem, DonHang.TRANGTHAI_DANGXULY);
