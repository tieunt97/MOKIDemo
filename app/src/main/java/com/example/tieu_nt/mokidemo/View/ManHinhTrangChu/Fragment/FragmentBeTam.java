...
public class FragmentBeTam extends Fragment implements ViewHienThiDanhSachSanPham{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_betam, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerBeTam);
        presenterLogicSanPham = new PresenterLogicSanPham(this);
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamBeTam");
        return view;
    }
