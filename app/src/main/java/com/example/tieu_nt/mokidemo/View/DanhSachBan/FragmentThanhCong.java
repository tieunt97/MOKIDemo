...
public class FragmentThanhCong extends Fragment implements ViewHienThiDSDonHang, ILoadMore {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterSanPhamKhachHangLogic.layDSDonHang("layDSDonHangBan", idKhachHang, 0, DonHang.TRANGTHAI_THANHCONG);
    ...
    public void loadMore(int tongItem) {
        List<DonHang> donHangLoadMore = presenterSanPhamKhachHangLogic.layDSDonHangLoadMore("layDSDonHangBan", idKhachHang, tongItem, DonHang.TRANGTHAI_THANHCONG);
