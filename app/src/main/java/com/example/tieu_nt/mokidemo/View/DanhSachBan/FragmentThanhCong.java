...
public class FragmentThanhCong extends Fragment implements ViewHienThiDSSanPhamKhachHang, ILoadMore {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterSanPhamKhachHangLogic.layDSSanPham("layDSSanPhamMuaBan", khachHang, 0, 1, 2);
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterSanPhamKhachHangLogic.layDSSanPhamLoadMore("layDSSanPhamMuaBan", khachHang, tongItem, 1, 2);
