...
public class FragmentDanhChoMe extends FragmentSanPham implements ViewHienThiDanhSachSanPham, ILoadMore{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamTheoLoaiSP", 10, 0, idKhachHang, giaTri, sapXep);

        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                refreshItems("layDanhSachSanPhamTheoLoaiSP", 10);
            }
        });
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterLogicSanPham.layDanhSachSanPhamLoadMore(
                "layDanhSachSanPhamTheoLoaiSP", 10, tongItem, idKhachHang, giaTri, sapXep);
