...
public class FragmentDanhChoMe extends Fragment implements ViewHienThiDanhSachSanPham{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_danhchome, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerDanhChoMe);
        presenterLogicSanPham = new PresenterLogicSanPham(this);
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamDanhChoMe");
        return view;
    }
