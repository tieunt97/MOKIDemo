...
public class FragmentBeVeSinh extends FragmentSanPham implements ViewHienThiDanhSachSanPham, ILoadMore{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamTheoLoaiSP", 6, 0, idKhachHang, giaTri, sapXep);

        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                refreshItems("layDanhSachSanPhamTheoLoaiSP", 6);
            }
        });
    ...
    public void setDangList(boolean dangList){
        ...
        presenterLogicSanPham.layDanhSachSanPham("layDanhSachSanPhamTheoLoaiSP", 6,
    ...
    public void loadMore(int tongItem) {
        List<SanPham> sanPhamLoadMore = presenterLogicSanPham.layDanhSachSanPhamLoadMore(
                "layDanhSachSanPhamTheoLoaiSP", 6, tongItem, idKhachHang, giaTri, sapXep);
