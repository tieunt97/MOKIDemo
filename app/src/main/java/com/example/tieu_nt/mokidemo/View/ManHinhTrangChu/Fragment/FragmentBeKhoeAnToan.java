...
public class FragmentBeKhoeAnToan extends Fragment implements ViewHienThiDanhSachSanPham{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_bekhoeantoan, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerBeKhoeAnToan);
